...
$route['runs/(:any)'] = 'Welcome/runs/$1';
$route['problem/(:any)'] = 'Welcome/problem/$1';

$route['add.do'] = 'Welcome/add_do';
$route['solution.do'] = 'Welcome/solve_do';

$route['teacher/login'] = 'Teacher/login_form';
$route['teacher/register.do'] = 'Teacher/register_do';
